...
<body>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="../home.jsp">Buy</a></li>
                  <li><a class="dropdown-item" href="home2.jsp">Sell</a></li>
                </ul>
              </li>
              <li class="nav-item">
    ...
    <%
    	...
    	Vector<ProductBean> vec = PDAO.finishallselect2();
    	for(int i=0; i<vec.size(); i++){
    		ProductBean pbean = vec.get(i);
    		
    		if(id.equals(pbean.getBuy_id()) || id.equals(pbean.getUser_id())){
    			Bean bean = PDAO.getProduct2(pbean.getProduct_id());
    			%>
