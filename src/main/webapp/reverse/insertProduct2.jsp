        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="home2.jsp">Account</a>
              </li>
...
<div class="alert">
	<h2>Register product by <span class="font">reverse auction system</span></h2>
</div>
<form action="insertProduct2Proc.jsp" method="post" enctype="multipart/form-data" >
